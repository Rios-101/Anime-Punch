...
const MobileMenu = () => {
  ...
  return (
      ...
      <div className="mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className=" items-center gap-5 hidden md:flex">
            <a href="#" className="hover:text-[#9BA4B5] text-[#FFFBF5]">
              Home
            </a>
            <a href="#" className="hover:text-[#9BA4B5] text-[#FFFBF5]">
              About
          ...
          <div className="-mr-2 flex md:hidden">
            <button
              type="button inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white"
    ...
    <div
        ...
        id="mobile-menu"
      >
        <div className="bg-[#191825] opacity-80 px-2 pt-2 pb-3 space-y-1 sm:px-3">
          <a
            href="#"
